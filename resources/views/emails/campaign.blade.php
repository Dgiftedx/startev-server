                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:60px; padding-right: 25px; padding-left: 25px;">
                                    ...
                                    <div style="color:#D4AE16;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:150%;padding-top:20px;padding-right:10px;padding-bottom:0px;padding-left:15px;">
                                        <div style="font-size: 12px; line-height: 18px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; color: #D4AE16;">
                                            {{--<p style="font-size: 14px; line-height: 75px; text-align: center; margin: 0;"><span style="font-size: 50px;"><strong><span style="line-height: 75px; font-size: 50px;"><span style="font-size: 38px; line-height: 57px;"><span style="color: #ff0000; font-size: 38px; line-height: 57px;">{!! $mailContent['subject']  !!}</span></span></strong></span></p>--}}
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
                                    ...
                                    <div style="color:#0068A5;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 26px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 18px; color: #0E146D;">
                                            <p style="line-height: 21px; text-align: center; font-size: 12px; margin: 0;"> {!! $mailContent['message']  !!} </p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
