                                ...
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:60px; padding-right: 25px; padding-left: 25px;">
                                    ...
                                    <div style="color:#0068A5;font-family:'Lato', Tahoma, Verdana, Segoe, sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px;">
                                        <div style="line-height: 14px; font-family: 'Lato', Tahoma, Verdana, Segoe, sans-serif; font-size: 12px; color: #0068A5;">
                                            <p style="line-height: 21px; text-align: center; font-size: 12px; margin: 0;"><span style="font-size: 18px;"> {!! $content !!} <br/> Startev - The largest entrepreneurial network of African Students.</span><br/><br/><span style="font-size: 18px; line-height: 21px;">Dear Mentor, Thousands of students are vigorously waiting for your mentor-ship, Please login to update your full profile and </span><strong><span style="font-size: 18px; line-height: 21px;">SHED</span></strong><span style="font-size: 18px; line-height: 21px;"> the light.</span> <br/> Don't Forget to explore our platform and revert your opinions</p>
                                        </div>
                                    </div>
                                    <!--[if mso]></td></tr></table><![endif]-->
