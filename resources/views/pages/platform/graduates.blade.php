...
@section('content')
    <div class="container-fluid" ng-controller="graduatesViewController">
        <!-- ============================================================== -->
        ...
        <div class="row page-titles">
            ...
            <div class="col-md-7 align-self-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Platform Graduate Users</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card" id="main-list">
                    <div class="card-body" coderty-loading="model.cargando_main">
                        <h4 class="card-title">Manage Platform Graduate Users</h4>
                        <div class="float-right mb-5">
                            <button ng-click="model.triggerUserForm('add')" type="button" class="btn waves-effect waves-light btn-rounded btn-success">Add New Graduate Account</button>
                        </div>
                                ...
                                <table datatable="ng" class="table table-bordered">
                                    ...
                                    <tr ng-repeat="user in model.users">
                                        ...
                                        <td class="text-nowrap">
                                            <button type="button" ng-click="model.editGraduate(user)" class="btn btn-circle btn-info"><i class="fa fa-edit"></i></button>
                                            @role('super')
                                            <button ng-click="model.deleteGraduateAccount(user)" type="button" class="btn btn-circle btn-danger"><i class="fa fa-trash"></i></button>
                                            @endrole
                                        </td>
                                    </tr>
                                        ...
                                        <div class="card-body">
                                            <form class="form">
                                                <div class="form-group m-t-40 row">
                                                    ...
                                                    <div class="col-9">
                                                        <input ng-model="model.graduateData.name" id="full_name" class="form-control" type="text" placeholder="Full Name">
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label for="email" class="col-3 col-form-label">Email</label>
                                                    <div class="col-9">
                                                        <input ng-model="model.graduateData.email" id="email" class="form-control" type="email" placeholder="Email Address">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <input ng-model="model.graduateData.institution" id="institution" class="form-control" type="text" placeholder="Institution">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <input ng-model="model.graduateData.password" class="form-control" type="password" placeholder="password">
                                                    </div>
                                                </div>
                                                @endhasanyrole
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <textarea ng-model="model.graduateData.address" class="form-control" placeholder="Residential Address"></textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-9">
                                                        <ui-select ng-model="model.graduateData.careerPath" width="100%" title="Choose career path">
...
@section('footerScript')
    <script src="{{ asset('/core-assets/scripts/controllers/platform/graduatesViewController.js') }}"></script>
@stop