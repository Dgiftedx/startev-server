...
@section('content')
    <div class="container-fluid" ng-controller="adminCancelledOrderViewController">
        <!-- ============================================================== -->
            ...
            <div class="col-12">
                <div class="card" id="main-list">
                    <div class="card-body" coderty-loading="model.cargando_main">
                        <h4 class="card-title">Manage Cancelled Orders</h4>
...
@section('footerScript')
    <script src="{{ asset('/core-assets/scripts/controllers/orders/adminCancelledOrderViewController.js') }}"></script>
@stop
