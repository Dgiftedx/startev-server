...
{{--                                </td>--}}
                                ...
                                <td>
                                    <button ng-if="order.status === 'confirmed'" button-spinner="model.finalizing" type="button" ng-click="model.conclude(order.id)" class="btn btn-sm waves-effect btn-info">Conclude Order</button>
