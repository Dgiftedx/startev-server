mainApp.controller('adminDeliveredOrderViewController', ['$rootScope','lodash','$scope','$location','$window','$timeout','SweetAlert','moment','adminService',
    function ($rootScope,lodash, $scope, $location, $window, $timeout,SweetAlert,moment, adminService) {
        ...
        $scope.model.loadOrdersIndex = function () {
            ...
            adminService.fetchData(
                '/admin/order/get-orders-index/delivered',
                function (resp) {
