mainApp.controller('adminDispatchedOrderViewController', ['$rootScope','lodash','$scope','$location','$window','$timeout','SweetAlert','moment','adminService',
    function ($rootScope,lodash, $scope, $location, $window, $timeout,SweetAlert,moment, adminService) {
        ...
        $scope.model.loadOrdersIndex = function () {
            ...
            adminService.fetchData(
                '/admin/order/get-orders-index/shipped',
                function (resp) {
