...
Route::group(['middleware' => ['auth:admin']], function () {
   ...
   Route::get('/transaction/get-index', 'Admin\TransactionsController@index');
    ...
    Route::get('manage-contents/feeds/getsetting','Admin\FeedsController@getfeedsSettings');
    ...
    Route::get('/payouts/pending-view', 'Admin\ViewsController@pendingPayoutView')->name('all pending payout');
